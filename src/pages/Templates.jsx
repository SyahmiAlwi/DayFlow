...
export function Templates() {
  ...
  const { templates, loadTemplates, addTemplate, updateTemplate, duplicateTemplate, deleteTemplate } = useTemplatesStore();
          ...
          <div key={template.id} className="card p-4 space-y-3">
            <div className="flex items-center justify-between gap-2">
              ...
              <div className="flex gap-2">
                ...
                <button className="pill bg-rose-100 text-rose-700 text-xs" onClick={() => handleDelete(template.id)}>
                  Delete
                </button>
              </div>
            </div>
